...
- Existing and new Node test suites: 289 passed, 0 failed, 4 skipped (293 total); 4 optional host-template document tests are explicitly skipped because those non-versioned instruction files are absent. No runtime behavior test is counted as passed when skipped.
