...
const optionalTemplateDocs = {
  skip: existsSync(join(TEMPLATE_ROOT, ".grok/skills/og"))
    ? false
    : "Optional Grok template instruction documents are not distributed with this repository; brand runtime tests remain active.",
};

test(
  "SKILL.md and AGENTS.md name the marker path and bound this script uses",
  optionalTemplateDocs,
  () => {
